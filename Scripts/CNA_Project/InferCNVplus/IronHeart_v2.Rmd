...
# Comparaison des tissus que l'on souhaite pour chaque échantillon
...
C'est intéressant : A retenir >>> Amplification sur la fin du chromosomes 8 pour les tumeurs épithéliales (un peu retrouvé dans tous les patients)
...
# Test statistiques sur les CNA scores (tiré du code d'Ines)   A ADAPTER

```{r}
# On importe les annotations correspondantes aux 16 patients
i = 1
for (sample_name in samples_names) {
  print(paste0("🔍  Importation des annotations pour ", sample_name))
  assign(paste0("ref", i), 
