...
\begin{frame}{MpBC sample}
    ...
    \begin{minipage}{\textwidth}
        \hspace{0.02cm} % décale légèrement à droite
...
\begin{frame}
	...
	\begin{figure}
		\centering
            ...
            \centering
            Analysis with \textbf{Seurat/MAST} \\
...
\begin{frame}{Analysis Conclusions}
    \begin{itemize}
        ...
        \begin{itemize} 
            \item Suggests a \textbf{shared common origin} for tumor subtypes
        \end{itemize}
        \vspace{0.5cm}
        \item \textbf{Rare cases} of chromosomal arm-level divergence between compartments  
        \begin{itemize} 
            \item May reflect \textbf{clonal evolution}, where one compartment originates from the other
        \end{itemize}
    \end{itemize}
\end{frame}
    ...
    \begin{block}{Main results}
        \begin{itemize}
            \item Identified \textbf{phenotypic markers} specific to  subtypes, but there is still limits (Visium resolutions)
                ...
                \end{itemize}
            \item \textbf{Limited genomic divergence} suggests a common origin of tumoral comparments in MpBC
